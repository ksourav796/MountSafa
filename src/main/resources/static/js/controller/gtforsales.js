...
//              $scope.selectedItemsList[$scope.accountIndex].qty = parseFloat(data.returnQty);
        ...
        $scope.getDuplicateReceipt = function (val) {
            ...
            $http.get($scope.generalTransactionServerURL   + '/getDuplicateReceipt?itemSearchText=' + val+"&locationId="+$scope.fromLocation).then(function (response) {
                var data = response.data;
        ...
        $scope.getPaymentTypesList1 = function (paymentTypeIndex, payIndex, flag) {
            ...
            $http.post($scope.hiposServerURL + '/getPaymentTypes').then(function (response) {
                var data = response.data;
