 ...
 */
@Entity
public class PosReceiptPaymentTypes {
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "native")
    @GenericGenerator(name = "native", strategy = "native")
    private Long posRepId;
    ...
    public Long getPosRepId() {
        return posRepId;
    }

    public void setPosRepId(Long posRepId) {
        this.posRepId = posRepId;
    }
    ...
    public OtherReceipt getOtherReceipt() {
        return otherReceipt;
    }

    public void setOtherReceipt(OtherReceipt otherReceipt) {
