...
public class StudentDTO {
    ...
    private boolean fatherPrimaryContact;
    private boolean motherPrimaryContact;
    private boolean gaurdianPrimaryContact;

    public boolean isFatherPrimaryContact() {
        return fatherPrimaryContact;
    }

    public void setFatherPrimaryContact(boolean fatherPrimaryContact) {
        this.fatherPrimaryContact = fatherPrimaryContact;
    }

    public boolean isMotherPrimaryContact() {
        return motherPrimaryContact;
    }

    public void setMotherPrimaryContact(boolean motherPrimaryContact) {
        this.motherPrimaryContact = motherPrimaryContact;
    }

    public boolean isGaurdianPrimaryContact() {
        return gaurdianPrimaryContact;
    }

    public void setGaurdianPrimaryContact(boolean gaurdianPrimaryContact) {
        this.gaurdianPrimaryContact = gaurdianPrimaryContact;
    }
