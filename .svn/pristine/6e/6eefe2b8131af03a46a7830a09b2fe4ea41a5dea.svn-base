app.controller('academicyearmasterController',
    function($scope, $http, $location, $filter, Notification, ngTableParams,  $timeout, $window, $rootScope) {
        ...
        $scope.getPaginatedAcademicYearList = function (page) {
            ...
            $http.post($scope.bshimServerURL  + '/getPaginatedAcdemicYearList?searchText=' + $scope.searchText+'&type='+$scope.inactiveStatus, angular.toJson(paginationDetails)).then(function (response) {
                var data = response.data;
