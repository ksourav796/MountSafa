...
app.config(['$routeProvider', function($routeProvider) {
    $routeProvider
        ...
        .when("/sourav",{
            templateUrl: "partials/sourav.html",
            controller: "souravController"
        })
        ...
        .when("/subjectCategory", {
            templateUrl: "partials/subjectCategory.html",
        ...
        .when("/marksSubmission", {
            templateUrl: "partials/marksSubmission.html",
            controller: "marksSubmissionController"
        })
        ...
        .when("/book", {
            templateUrl: "partials/booksystem.html",
        })
