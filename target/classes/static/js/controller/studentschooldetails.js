    ...
    function($scope, $http, $location, $filter, Notification, ngTableParams,  $timeout, $window, $rootScope) {
        ...
        $scope.saveSchoolsDetails = function () {
            if (angular.isUndefined($scope.branchCode) || $scope.branchCode == '') {
                ...
                Notification.warning({message: 'address Can Not be Empty', positionX: 'center', delay: 2000});
            }  else if(angular.isUndefined($scope.city) || $scope.city == '' ){
                Notification.warning({message: 'city Can Not be Empty', positionX: 'center', delay: 2000});
            } else if(angular.isUndefined($scope.pinCode) || $scope.pinCode == '' ){
                Notification.warning({message: 'pinCode Can Not be Empty', positionX: 'center', delay: 2000});
            }else if(angular.isUndefined($scope.state) || $scope.state == '' ){
                ...
                Notification.warning({message: 'phoneNumber Can Not be Empty', positionX: 'center', delay: 2000});
            ...
            }else if(angular.isUndefined($scope.termsandconditions) || $scope.termsandconditions == '' ){
                Notification.warning({message: 'terms and conditions Can Not be Empty', positionX: 'center', delay: 2000});
            }else if(angular.isUndefined($scope.receiptfooterdesc) || $scope.receiptfooterdesc == '' ) {
                Notification.warning({message: 'receipt footer Can Not be Empty', positionX: 'center', delay: 2000});
            }
            // else if(angular.isUndefined($scope.emailId) || $scope.emailId == ''){
