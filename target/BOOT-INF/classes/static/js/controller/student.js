app.controller('studentController',
    function ($scope, $rootScope, $http, $location, $window, $filter, Notification) {
        ...
        $scope.getPaginatedStudentList = function (page) {
            ...
            $http.post($scope.bshimServerURL  + '/getPaginatedStudentList?searchText=' + $scope.SearchText+'&checkboxStatusForStudent='+$scope.checkboxStatusForStudent+'&gradeSearch='+$scope.gradeNameText+'&studentSearch='+$scope.studentText,angular.toJson(paginationDetails)).then(function (response) {
